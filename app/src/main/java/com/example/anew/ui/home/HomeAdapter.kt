...
class HomeAdapter(private val context: Context, private val adminhomeMedicineList:MutableList<AdminhomeData>) : RecyclerView.Adapter<HomeHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeHolder {
        val view =
            LayoutInflater.from(context).inflate(R.layout.home_single_item_layout, parent, false)
